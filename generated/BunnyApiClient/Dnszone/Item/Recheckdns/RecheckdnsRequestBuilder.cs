...
namespace BunnyApiClient.Dnszone.Item.Recheckdns
{
    ...
    /// </summary>
    public class RecheckdnsRequestBuilder : BaseCliRequestBuilder
    {
        /// <summary>
        ...
        public Command BuildPostCommand()
        {
            ...
            command.Description = "[RecheckDnsConfiguration API Docs](https://docs.bunny.net/reference/dnszonepublic_recheckdns)";
        ...
        public RecheckdnsRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/dnszone/{%2Did}/recheckdns", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="BunnyApiClient.Dnszone.Item.Recheckdns.RecheckdnsRequestBuilder"/> and sets the default values.
        ...
        public RecheckdnsRequestBuilder(string rawUrl) : base("{+baseurl}/dnszone/{%2Did}/recheckdns", rawUrl)
        {
        }
        /// <summary>
        /// [RecheckDnsConfiguration API Docs](https://docs.bunny.net/reference/dnszonepublic_recheckdns)
