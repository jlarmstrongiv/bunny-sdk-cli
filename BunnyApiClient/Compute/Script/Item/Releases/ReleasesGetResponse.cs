...
#nullable enable
        public List<global::BunnyApiClient.Models.Compute.ScriptRelease>? Items { get; set; }
#nullable restore
#else
        public List<global::BunnyApiClient.Models.Compute.ScriptRelease> Items { get; set; }
#endif
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::BunnyApiClient.Compute.Script.Item.Releases.ReleasesGetResponse"/> and sets the default values.
        /// </summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "Items", n => { Items = n.GetCollectionOfObjectValues<global::BunnyApiClient.Models.Compute.ScriptRelease>(global::BunnyApiClient.Models.Compute.ScriptRelease.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::BunnyApiClient.Models.Compute.ScriptRelease>("Items", Items);
