...
namespace BunnyApiClient.Compute.Script.Item.Variables.Add
{
    ...
    public partial class AddRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildPostCommand()
        {
            ...
            command.Description = "[AddComputeScriptVariable API Docs](https://docs.bunny.net/reference/computeedgescriptpublic_addvariable)";
        ...
        public AddRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/compute/script/{id}/variables/add", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::BunnyApiClient.Compute.Script.Item.Variables.Add.AddRequestBuilder"/> and sets the default values.
        ...
        public AddRequestBuilder(string rawUrl) : base("{+baseurl}/compute/script/{id}/variables/add", rawUrl)
        {
        }
        /// <summary>
        /// [AddComputeScriptVariable API Docs](https://docs.bunny.net/reference/computeedgescriptpublic_addvariable)
