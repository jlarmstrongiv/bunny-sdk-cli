...
namespace BunnyApiClient.Dmca.Item
{
    ...
    /// </summary>
    public class DmcaItemRequestBuilder : BaseCliRequestBuilder
    {
        /// <summary>
        ...
        public Command BuildGetCommand()
        {
            ...
            command.Description = "[GetDmcaCase API Docs](https://docs.bunny.net/reference/abusecasepublic_getabusecase)";
        ...
        public Command BuildResolveNavCommand()
        {
            ...
            var builder = new global::BunnyApiClient.Dmca.Item.Resolve.ResolveRequestBuilder(PathParameters);
        ...
        public DmcaItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/dmca/{id}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="BunnyApiClient.Dmca.Item.DmcaItemRequestBuilder"/> and sets the default values.
        ...
        public DmcaItemRequestBuilder(string rawUrl) : base("{+baseurl}/dmca/{id}", rawUrl)
        {
        }
        /// <summary>
        /// [GetDmcaCase API Docs](https://docs.bunny.net/reference/abusecasepublic_getabusecase)
