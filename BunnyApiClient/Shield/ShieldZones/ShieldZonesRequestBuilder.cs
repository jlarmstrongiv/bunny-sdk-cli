...
namespace BunnyApiClient.Shield.ShieldZones
{
    ...
    public partial class ShieldZonesRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public ShieldZonesRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/shield/shield-zones{?page,perPage}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::BunnyApiClient.Shield.ShieldZones.ShieldZonesRequestBuilder"/> and sets the default values.
        ...
        public ShieldZonesRequestBuilder(string rawUrl) : base("{+baseurl}/shield/shield-zones{?page,perPage}", rawUrl)
        {
        }
