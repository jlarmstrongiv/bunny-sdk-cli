...
#nullable restore
        ...
        /// <summary>
        /// Instantiates a new <see cref="StreamApiClient.Models.ManageVideos.Video"/> and sets the default values.
        /// </summary>
        public Video()
        {
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "captions", n => { Captions = n.GetCollectionOfObjectValues<global::StreamApiClient.Models.ManageVideos.Caption>(global::StreamApiClient.Models.ManageVideos.Caption.CreateFromDiscriminatorValue)?.ToList(); } },
                { "category", n => { Category = n.GetEnumValue<global::StreamApiClient.Models.ManageVideos.Video_category>(); } },
                { "chapters", n => { Chapters = n.GetCollectionOfObjectValues<global::StreamApiClient.Models.ManageVideos.Chapter>(global::StreamApiClient.Models.ManageVideos.Chapter.CreateFromDiscriminatorValue)?.ToList(); } },
                ...
                { "metaTags", n => { MetaTags = n.GetCollectionOfObjectValues<global::StreamApiClient.Models.ManageVideos.MetaTag>(global::StreamApiClient.Models.ManageVideos.MetaTag.CreateFromDiscriminatorValue)?.ToList(); } },
                { "moments", n => { Moments = n.GetCollectionOfObjectValues<global::StreamApiClient.Models.ManageVideos.Moment>(global::StreamApiClient.Models.ManageVideos.Moment.CreateFromDiscriminatorValue)?.ToList(); } },
                ...
                { "transcodingMessages", n => { TranscodingMessages = n.GetCollectionOfObjectValues<global::StreamApiClient.Models.ManageVideos.TranscodingMessage.TranscodingMessage>(global::StreamApiClient.Models.ManageVideos.TranscodingMessage.TranscodingMessage.CreateFromDiscriminatorValue)?.ToList(); } },
