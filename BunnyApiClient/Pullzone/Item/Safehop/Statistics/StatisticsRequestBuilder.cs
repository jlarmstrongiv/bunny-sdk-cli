...
namespace BunnyApiClient.Pullzone.Item.Safehop.Statistics
{
    ...
    public partial class StatisticsRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildGetCommand()
        {
            ...
            command.Description = "[GetSafeHopStatistics API Docs](https://docs.bunny.net/reference/pullzonepublic_safehopstatistics)";
        ...
        public StatisticsRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/pullzone/{%2Did}/safehop/statistics{?dateFrom*,dateTo*,hourly*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::BunnyApiClient.Pullzone.Item.Safehop.Statistics.StatisticsRequestBuilder"/> and sets the default values.
