...
namespace BunnyApiClient.Models.DnsZone.UpdateDnsRecord
{
    ...
    /// </summary>
    public class OptionalParameters : IAdditionalDataHolder, IParsable
    {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::BunnyApiClient.Models.DnsZone.UpdateDnsRecord.OptionalParameters_EnviromentalVariables>? EnviromentalVariables { get; set; }
#nullable restore
#else
        public List<global::BunnyApiClient.Models.DnsZone.UpdateDnsRecord.OptionalParameters_EnviromentalVariables> EnviromentalVariables { get; set; }
#endif
...
#nullable restore
        ...
        /// <summary>
        /// Instantiates a new <see cref="BunnyApiClient.Models.DnsZone.UpdateDnsRecord.OptionalParameters"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="BunnyApiClient.Models.DnsZone.UpdateDnsRecord.OptionalParameters"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::BunnyApiClient.Models.DnsZone.UpdateDnsRecord.OptionalParameters CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::BunnyApiClient.Models.DnsZone.UpdateDnsRecord.OptionalParameters();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "EnviromentalVariables", n => { EnviromentalVariables = n.GetCollectionOfObjectValues<global::BunnyApiClient.Models.DnsZone.UpdateDnsRecord.OptionalParameters_EnviromentalVariables>(global::BunnyApiClient.Models.DnsZone.UpdateDnsRecord.OptionalParameters_EnviromentalVariables.CreateFromDiscriminatorValue)?.ToList(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::BunnyApiClient.Models.DnsZone.UpdateDnsRecord.OptionalParameters_EnviromentalVariables>("EnviromentalVariables", EnviromentalVariables);
