...
namespace BunnyApiClient.Shield.Waf.CustomRules.Item
{
    ...
    public partial class WithShieldZoneItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public WithShieldZoneItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/shield/waf/custom-rules/{shieldZoneId}{?page,perPage}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::BunnyApiClient.Shield.Waf.CustomRules.Item.WithShieldZoneItemRequestBuilder"/> and sets the default values.
        ...
        public WithShieldZoneItemRequestBuilder(string rawUrl) : base("{+baseurl}/shield/waf/custom-rules/{shieldZoneId}{?page,perPage}", rawUrl)
        {
        }
