...
namespace BunnyApiClient.Shield.ShieldZone.Item
{
    ...
    public partial class WithShieldZoneItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public WithShieldZoneItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/shield/shield-zone/{shieldZoneId}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::BunnyApiClient.Shield.ShieldZone.Item.WithShieldZoneItemRequestBuilder"/> and sets the default values.
        ...
        public WithShieldZoneItemRequestBuilder(string rawUrl) : base("{+baseurl}/shield/shield-zone/{shieldZoneId}", rawUrl)
        {
        }
