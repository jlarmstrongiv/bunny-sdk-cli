...
namespace BunnyApiClient.Shield.RateLimit
{
    ...
    public partial class RateLimitRequestBuilder : BaseCliRequestBuilder
    {
        /// <summary>
        ...
        public Tuple<List<Command>, List<Command>> BuildCommand()
        {
            ...
            var builder = new global::BunnyApiClient.Shield.RateLimit.Item.RateLimitItemRequestBuilder(PathParameters);
        ...
        public Command BuildCreateCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<global::BunnyApiClient.Models.Shield.CreateWafRateLimitRequest>(global::BunnyApiClient.Models.Shield.CreateWafRateLimitRequest.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        public RateLimitRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/shield/rate-limit", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::BunnyApiClient.Shield.RateLimit.RateLimitRequestBuilder"/> and sets the default values.
        ...
        public RateLimitRequestBuilder(string rawUrl) : base("{+baseurl}/shield/rate-limit", rawUrl)
        {
        }
